package com.kadadevelopers.ads.interstitial;
                ...
                case APPODEAL:
                    Appodeal.setInterstitialCallbacks(new InterstitialCallbacks() {
                        ...
                        public void onInterstitialLoaded(boolean isPrecache) {
                            ...
                            Log.d(TAG, "Appodeal Interstitial Ad is loaded");
                        }
                        @Override
                        ...
                        public void onInterstitialClosed() {
                            ...
                            Log.d(TAG, "Appodeal Interstitial Ad is closed");
                        }
                        @Override
                ...
                switch (adNetwork) {
                    ...
                    case APPODEAL:
                        if (Appodeal.isLoaded(Appodeal.INTERSTITIAL)) {
                            ...
                            Log.d(TAG, "Appodeal Interstitial Ad is loaded and show it");
                        } else {
                            showBackupInterstitialAd();
                            Log.d(TAG, "Failed to load Appodeal Interstitial Ad");
                        }
                        break;
