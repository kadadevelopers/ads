package com.kadadevelopers.ads.initialization;
...
import com.kadadevelopers.ads.rest.RestAdapter;
                        ...
                        if (!filteredAppList.isEmpty()) {
                            new MaterialAlertDialogBuilder(activity)
                                    ...
                                    .setNegativeButton("I have a Valid License", (dialog, which) -> {
                                        ...
                                        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"help.kadadevelopers@gmail.com"});
