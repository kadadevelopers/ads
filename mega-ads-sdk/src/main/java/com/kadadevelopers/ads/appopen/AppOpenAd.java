package com.kadadevelopers.ads.appopen;
...
public class AppOpenAd {
    ...
    public com.wortise.ads.appopen.AppOpenAd wortiseAppOpenAd = null;
                ...
                if (wortiseAppOpenAd != null) {
                    if (wortiseAppOpenAd.isAvailable()) {
                        wortiseAppOpenAd.setListener(new com.wortise.ads.appopen.AppOpenAd.Listener() {
                            ...
                            public void onAppOpenFailedToShow(@NonNull com.wortise.ads.appopen.AppOpenAd appOpenAd, @NonNull com.wortise.ads.AdError adError) {
                                onShowAdCompleteListener.onShowAdComplete();
                                Log.d(TAG, "[" + adNetwork + "] " + "app open ad load failed: " + adError);
                            }
                        ...
                        showBackupAppOpenAd(onShowAdCompleteListener);
                        Log.d(TAG, "[" + adNetwork + "] " + " Wortise App Open Ad is not available, try to show Backup Ads");
                    }
                } else {
                    showBackupAppOpenAd(onShowAdCompleteListener);
                    Log.d(TAG, "[" + adNetwork + "] " + " Failed to Show App Open Ad, try to show Backup Ads");
                ...
                case WORTISE:
                    ...
                    wortiseAppOpenAd.setListener(new com.wortise.ads.appopen.AppOpenAd.Listener() {
                        ...
                        public void onAppOpenFailedToShow(@NonNull com.wortise.ads.appopen.AppOpenAd appOpenAd, @NonNull com.wortise.ads.AdError adError) {
                            wortiseAppOpenAd = null;
                            isAppOpenAdLoaded = false;
                            Log.d(TAG, "[" + backupAdNetwork + "] [backup] " + "[on resume] failed to load app open ad: " + adError);
                        }
                ...
                if (wortiseAppOpenAd != null) {
                    if (wortiseAppOpenAd.isAvailable()) {
                        wortiseAppOpenAd.setListener(new com.wortise.ads.appopen.AppOpenAd.Listener() {
                            ...
                            @Override
                            public void onAppOpenFailedToShow(@NonNull com.wortise.ads.appopen.AppOpenAd appOpenAd, @NonNull com.wortise.ads.AdError adError) {
                                Log.d(TAG, "[" + backupAdNetwork + "] [backup] " + "app open ad load failed: " + adError);
                            }
                        ...
                        onShowAdCompleteListener.onShowAdComplete();
                        Log.d(TAG, "[" + backupAdNetwork + "] [backup] " + " Wortise App Open Ad is not available, try to show Backup Ads");
                    }
                } else {
                    onShowAdCompleteListener.onShowAdComplete();
                    Log.d(TAG, "[" + backupAdNetwork + "] [backup] " + " Failed to Show App Open Ad, try to show Backup Ads");
